# 📋 Hyper Quality Screenshots Release Queue & Backlog (MC 26.3)
...
- [ ] **`1.2.2+26.3`** (2026-09-05) - - **Ko-fi Support Integration**: Injected top-pinned Ko-fi creator support button across Capture & Feedback category tabs in YACL configuration screen.
- [ ] **`1.2.0+26.3`** - Brigadier client command suite (/hyperscreenshots, /hypershot, /hqss).
...
- [ ] **`1.1.3+26.3`** - Expand automated tests for Auto-Hide Hand toggle and capture state.
